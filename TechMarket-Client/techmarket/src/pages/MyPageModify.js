        ...
        <>
            <section className="profile-section">
                ...
                <div className="profile-info">
                    ...
                    <div className="profile-group">
                        <span>닉네임 </span>
                        <input type="text" defaultValue={userInfo.username} onChange={handleIdInputValue("username")} />
                    </div>
                    
                    <div className="profile-group">
                        <span>비밀번호 </span>
                        <input type="text" defaultValue={userInfo.password} onChange={handlePasswordInputValue("password")}/>
                    </div>
